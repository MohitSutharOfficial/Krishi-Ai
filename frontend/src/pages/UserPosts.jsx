...
function UserPosts() {
    ...
    return (
        <div className="bg-gradient-to-b from-[#FEFAE0] to-white text-gray-800 min-h-screen">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        {posts.map((post) => (
                            <div key={`${post.message}+1`} className="w-full">
                                <div className="bg-green-50 rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300 h-full flex flex-col relative group">
                                    ...
                                    <div className="px-6 py-3 bg-white border-t border-gray-500 flex justify-between items-center">
